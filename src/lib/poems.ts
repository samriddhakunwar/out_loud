...
export const poems: Poem[] = [
  {
    ...
    content: [
      { type: 'caption', text: 'Nørholm Kirke, across the churchyard.' },
      ...
      { type: 'caption', text: 'Two old trees, and the church waiting in the gap between them. I liked that you had to look past something to find it.' },
      ...
      { type: 'caption', text: 'The dry stone wall and the first daffodils, spring arriving the way it does up here, quietly and a few weeks late.' },
